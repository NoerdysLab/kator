...
export const mockBallotData: BallotData = {
  ...
  divisions: [
    { ocdId: "ocd-division/country:us", name: "United States", level: "federal" },
    { ocdId: "ocd-division/country:us/state:ca", name: "California", level: "state" },
    { ocdId: "ocd-division/country:us/state:ca/county:san_francisco", name: "San Francisco County", level: "local" },
    { ocdId: "ocd-division/country:us/state:ca/place:san_francisco", name: "City of San Francisco", level: "local" },
    { ocdId: "ocd-division/country:us/state:ca/cd:11", name: "California's 11th Congressional District", level: "local" },
    { ocdId: "ocd-division/country:us/state:ca/sldl:17", name: "California State Assembly District 17", level: "local" },
    { ocdId: "ocd-division/country:us/state:ca/sldu:11", name: "California State Senate District 11", level: "local" },
  ],
  address: "1 Dr Carlton B Goodlett Pl, San Francisco, CA 94102",
  isMockData: true,
